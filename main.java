...
public class main {
	...
	public static void searchDef(String word) throws Exception{
		String ua = "http://www.dictionaryapi.com/api/v1/references/collegiate/xml/"+word+"$key";
        URL a = new URL(ua);
	...
	public static void searchSyn(String word) throws Exception{
		...
		String ua = "http://www.dictionaryapi.com/api/v1/references/thesaurus/xml/"+word+"?$key";
        URL a = new URL(ua);
        URLConnection b = a.openConnection();
        BufferedReader c = new BufferedReader(new InputStreamReader(a.openStream()));
        String result = "";
